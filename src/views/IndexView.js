        ...
        <span className="af-view">
          <div>
            ...
            <div className="af-class-section af-class-hero af-class-wf-section">
              <div className="af-class-container">
                <div className="af-class-center-container">
                  <h1 data-w-id="f16083d7-8362-90e8-c637-b4b8e290894c" style={{opacity: 0}} className="af-class-h1 af-class-bottom-margin">WELCOME TO<br />EQUAL CRYPTO PEOPLE<br /></h1>
                  <div data-w-id="a8fdeaa4-85b8-2c7a-f132-70416e65eb55" style={{opacity: 0}} className="af-class-small-text af-class-white">The war against sharing culture, art, and music ends here. </div>
                  <div data-w-id="be82ec17-97f6-5e3a-781f-442e406d11fd" style={{opacity: 0}} className="af-class-small-text af-class-white">10,000 Equal Crypto People will mint in January 2022. <br /></div><img src="images/arrow.svg" loading="lazy" style={{opacity: 0}} data-w-id="ad62e81f-8e3f-e022-2e4c-d2516283b71e" alt="arrow" className="af-class-image" />
                </div>
              </div>
            </div>
            <div className="af-class-section af-class-wf-section">
              <div className="af-class-container">
                <div data-w-id="1be5832c-61ad-0e81-33be-a713efe6cb68" style={{opacity: 0}} className="af-class-main-grid">
            ...
            <div id="About" className="af-class-section af-class-wf-section">
              <div className="af-class-container">
                <div className="af-class-two-col-grid">
                  <div data-w-id="2a4e826d-972b-9756-0c5c-ea029763ce74" style={{opacity: 0}} className="af-class-small-container">
                    <div data-w-id="2a4e826d-972b-9756-0c5c-ea029763ce75" style={{opacity: 0}} className="af-class-small-text af-class-primary">Equal Crypto People (ECP)</div>
                    <h2 data-w-id="2a4e826d-972b-9756-0c5c-ea029763ce77" style={{opacity: 0}} className="af-class-h2 af-class-margin">WHO ARE THE&nbsp;ECP?</h2>
                    <div data-w-id="2a4e826d-972b-9756-0c5c-ea029763ce79" style={{opacity: 0}} className="af-class-text">Before going underground, there was a population of the world that survived solely by the curation of art and music – but then the war happened…<br /><br />Imagine a world where…regardless of race, creed, gender, or socioeconomic status – you were considered a lifeline to the very thing that would keep us alive… oxygen.<br /><br />In our world, oxygen is the curation of art and music – globally.<br /><br />The world you’re entering into is the Equal Crypto People – The ECP…<br /><br />The ECP went underground because there was a war against humanity – and the embrace of culture. It is your duty, as a member of the ECP, to share some of the best art and music that touches your soul – and that you feel others should breathe. <br /><br />Remember… our oxygen is art and music – we are depending on you. <br /><br />We must find all of the ECPs that went underground…Take a look at our roadmap to begin the journey back.</div>
                  ...
                  <div data-w-id="2a4e826d-972b-9756-0c5c-ea029763ce7e" style={{opacity: 0}} className="af-class-image-wrapper">
                    <a href="#" className="af-class-video-wrapper w-inline-block w-lightbox">
                      <div className="af-class-play-button"><img src="images/play_button_icon.svg" loading="lazy" alt="play button" className="af-class-play-icon af-class-large" /></div><img src="images/Screen-Shot-2021-12-18-at-3.11.54-PM.png" loading="lazy" sizes="(max-width: 479px) 89vw, (max-width: 767px) 364.6875px, (max-width: 991px) 47vw, 45vw" srcSet="images/Screen-Shot-2021-12-18-at-3.11.54-PM-p-500.png 500w, images/Screen-Shot-2021-12-18-at-3.11.54-PM-p-800.png 800w, images/Screen-Shot-2021-12-18-at-3.11.54-PM-p-1080.png 1080w, images/Screen-Shot-2021-12-18-at-3.11.54-PM-p-1600.png 1600w, images/Screen-Shot-2021-12-18-at-3.11.54-PM.png 1754w" alt="The Door to the ECP Metaverse" className="af-class-image-section af-class-v1" />
                    </a>
              ...
              <div className="af-class-container">
                <div className="af-class-two-col-grid">
                  <div className="af-class-small-container">
                    <div data-w-id="1933ef09-3461-666a-4b4f-65c0da79e404" style={{opacity: 0}} className="af-class-small-text af-class-primary">Join Us | Sharing of Culture is Our Oxygen. </div>
                    <h2 data-w-id="1933ef09-3461-666a-4b4f-65c0da79e406" style={{opacity: 0}} className="af-class-h2 af-class-margin">ECP | RARITY</h2>
                    <div data-w-id="1933ef09-3461-666a-4b4f-65c0da79e40a" style={{opacity: 0}} className="af-class-text">ECPs are unique and programmatically generated. They represent freedom of expression and boast unique swag. From the trendsetters, loners, jokesters, jocks to the socially awkward, the ECP is a collective of us all.</div>
            ...
            <div id="Speakers" className="af-class-section af-class-white af-class-wf-section">
              <div className="af-class-container">
                <div className="af-class-center-container">
                  <h2 data-w-id="c7399da4-4767-7835-dc3a-0b382c8a1a4f" style={{opacity: 0}} className="af-class-h2 af-class-dark">EQUAL CRYPTO PEOPLE&nbsp;TEAM</h2>
                </div>
                <div className="af-class-main-grid af-class-top-margin af-class-ec">
                  <div id="w-node-e989fd78-2815-49b1-4555-2373e61b0508-3eed4f0e" data-w-id="e989fd78-2815-49b1-4555-2373e61b0508" style={{opacity: 0}} className="af-class-small-container">
                  ...
                  <div id="w-node-_52dbf247-5728-0e4a-d593-f295322bec7e-3eed4f0e" data-w-id="52dbf247-5728-0e4a-d593-f295322bec7e" style={{opacity: 0}} className="af-class-small-container">
                    <div className="af-class-avatar-wrapper"><img src="images/Kiya-ECP-NFT.png" loading="lazy" sizes="(max-width: 479px) 89vw, (max-width: 991px) 20vw, 53.97500228881836px" srcSet="images/Kiya-ECP-NFT-p-500.png 500w, images/Kiya-ECP-NFT-p-800.png 800w, images/Kiya-ECP-NFT.png 1000w" alt="Co-Creator of Equal Crypto People" className="af-class-image-section" /></div>
                    <h3 className="af-class-h4 af-class-dark">Kiya</h3>
                    <div className="af-class-text af-class-dark">Co-Creator<br />‍</div>
                  </div>
                  <div id="w-node-_628df591-09c4-6583-a248-28a4cdf6b021-3eed4f0e" data-w-id="628df591-09c4-6583-a248-28a4cdf6b021" style={{opacity: 0}} className="af-class-small-container">
                  ...
                  <div id="w-node-d5ebc628-4a35-6af7-a025-b5cd33bacec4-3eed4f0e" data-w-id="d5ebc628-4a35-6af7-a025-b5cd33bacec4" style={{opacity: 0}} className="af-class-small-container">
            ...
            <div id="Agenda" className="af-class-section af-class-white af-class-wf-section">
              <div className="af-class-container">
                <div className="af-class-center-container">
                  <h2 data-w-id="23b06ef8-5a23-aefe-3fe6-0c8916779d46" style={{opacity: 0}} className="af-class-h2 af-class-dark">OUR ROADMAP &amp;&nbsp;FAQs</h2>
                ...
                <div data-w-id="b13cdc34-87d1-4c58-63b8-cac155197fe1" style={{opacity: 0}} data-current="Tab 1" data-easing="ease" data-duration-in={300} data-duration-out={100} className="af-class-tabs w-tabs">
                  ...
                  <div className="af-class-tabs-content w-tab-content">
                    <div data-w-tab="Tab 1" className="af-class-tab-pane w-tab-pane w--tab-active">
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-b62165f3-3ea4-bab0-41b9-b57220e1dcda-3eed4f0e" className="af-class-bold-text af-class-hour">1/1/22</div><img id="w-node-b62165f3-3ea4-bab0-41b9-b57220e1dcdc-3eed4f0e" loading="lazy" src="images/ECP-256x256.png" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_2a8c1e70-70ba-3e95-38ef-1e8b127bcfe8-3eed4f0e" className="af-class-bold-text af-class-hour">1/15/22</div><img id="w-node-_2a8c1e70-70ba-3e95-38ef-1e8b127bcfea-3eed4f0e" sizes="(max-width: 479px) 22vw, (max-width: 767px) 2vw, (max-width: 991px) 7vw, 70px" src="images/135.jpg" loading="lazy" srcSet="images/135-p-500.jpeg 500w, images/135-p-800.jpeg 800w, images/135-p-1080.jpeg 1080w, images/135-p-1600.jpeg 1600w, images/135-p-2000.jpeg 2000w, images/135-p-2600.jpeg 2600w, images/135-p-3200.jpeg 3200w, images/135.jpg 5000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_7db7ff47-d599-594b-3bab-93b18c892548-3eed4f0e" className="af-class-bold-text af-class-hour">1/29/22</div><img id="w-node-_7db7ff47-d599-594b-3bab-93b18c89254a-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/next_step.jpg" loading="lazy" srcSet="images/next_step-p-500.jpeg 500w, images/next_step-p-800.jpeg 800w, images/next_step-p-1080.jpeg 1080w, images/next_step-p-1600.jpeg 1600w, images/next_step-p-2000.jpeg 2000w, images/next_step-p-2600.jpeg 2600w, images/next_step-p-3200.jpeg 3200w, images/next_step.jpg 4167w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_09ec31a1-d94d-27d5-3dc1-76182a737c46-3eed4f0e" className="af-class-bold-text af-class-hour">2/26/22</div><img id="w-node-_09ec31a1-d94d-27d5-3dc1-76182a737c48-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/159.jpg" loading="lazy" srcSet="images/159-p-500.jpeg 500w, images/159-p-800.jpeg 800w, images/159-p-1080.jpeg 1080w, images/159-p-1600.jpeg 1600w, images/159-p-2000.jpeg 2000w, images/159-p-2600.jpeg 2600w, images/159-p-3200.jpeg 3200w, images/159.jpg 5000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_662d2c4b-1f3f-f32a-b2f6-08acafdf3248-3eed4f0e" className="af-class-bold-text af-class-hour">3/12/22</div><img id="w-node-_662d2c4b-1f3f-f32a-b2f6-08acafdf324a-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/617455930f1ea325a21fb1ae.jpg" loading="lazy" srcSet="images/617455930f1ea325a21fb1ae-p-500.jpeg 500w, images/617455930f1ea325a21fb1ae-p-800.jpeg 800w, images/617455930f1ea325a21fb1ae-p-1080.jpeg 1080w, images/617455930f1ea325a21fb1ae-p-1600.jpeg 1600w, images/617455930f1ea325a21fb1ae-p-2000.jpeg 2000w, images/617455930f1ea325a21fb1ae-p-2600.jpeg 2600w, images/617455930f1ea325a21fb1ae-p-3200.jpeg 3200w, images/617455930f1ea325a21fb1ae.jpg 7974w" alt className="af-class-small-avatar" />
                            ...
                            <div id="w-node-_662d2c4b-1f3f-f32a-b2f6-08acafdf324d-3eed4f0e" className="af-class-text af-class-dark">As Outlined in Our Financial Plan, NFT &amp; Merch Funds will Procure Venues</div><img src="placeholder.svg" loading="lazy" alt />
                          </div>
                          <div className="af-class-horizontal-container"><img loading="lazy" src="images/plus-icon.svg" alt="plus icon" className="af-class-plus" /></div>
                        </div>
                        <nav className="af-class-accordion-text w-dropdown-list">
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-ac38f526-cd73-9302-4bcc-575edfb51ac5-3eed4f0e" className="af-class-bold-text af-class-hour">6/1/22</div><img id="w-node-ac38f526-cd73-9302-4bcc-575edfb51ac7-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/02581.jpg" loading="lazy" srcSet="images/02581-p-500.jpeg 500w, images/02581-p-800.jpeg 800w, images/02581-p-1080.jpeg 1080w, images/02581-p-1600.jpeg 1600w, images/02581-p-2000.jpeg 2000w, images/02581-p-2600.jpeg 2600w, images/02581-p-3200.jpeg 3200w, images/02581.jpg 6000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-e63ad79e-4366-0903-836c-de1f480d057b-3eed4f0e" className="af-class-bold-text af-class-hour">7/1/22</div><img id="w-node-e63ad79e-4366-0903-836c-de1f480d057d-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/11Z_Neon_815.jpg" loading="lazy" srcSet="images/11Z_Neon_815-p-500.jpeg 500w, images/11Z_Neon_815-p-800.jpeg 800w, images/11Z_Neon_815-p-1080.jpeg 1080w, images/11Z_Neon_815-p-1600.jpeg 1600w, images/11Z_Neon_815-p-2000.jpeg 2000w, images/11Z_Neon_815-p-2600.jpeg 2600w, images/11Z_Neon_815-p-3200.jpeg 3200w, images/11Z_Neon_815.jpg 4000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_78c2dd65-3d04-affb-7e8d-d7e58686f03c-3eed4f0e" className="af-class-bold-text af-class-hour">10/1/22</div><img id="w-node-_78c2dd65-3d04-affb-7e8d-d7e58686f03e-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/5379727.jpg" loading="lazy" srcSet="images/5379727-p-500.jpeg 500w, images/5379727-p-800.jpeg 800w, images/5379727-p-1080.jpeg 1080w, images/5379727-p-1600.jpeg 1600w, images/5379727.jpg 2000w" alt className="af-class-small-avatar" />
                    ...
                    <div data-w-tab="Tab 2" className="af-class-tab-pane w-tab-pane">
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-cecf1ef9-d9e1-39e8-69a8-5c0413829499-3eed4f0e" className="af-class-bold-text af-class-hour">10%</div><img id="w-node-cecf1ef9-d9e1-39e8-69a8-5c041382949b-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/5351324.jpg" loading="lazy" srcSet="images/5351324-p-800.jpeg 800w, images/5351324-p-1080.jpeg 1080w, images/5351324-p-1600.jpeg 1600w, images/5351324.jpg 2000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294a9-3eed4f0e" className="af-class-bold-text af-class-hour">25%</div><img id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294ab-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/6443477.jpg" loading="lazy" srcSet="images/6443477-p-800.jpeg 800w, images/6443477-p-1080.jpeg 1080w, images/6443477-p-1600.jpeg 1600w, images/6443477.jpg 2000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294b7-3eed4f0e" className="af-class-bold-text af-class-hour">50%</div><img id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294b9-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/4912366.jpg" loading="lazy" srcSet="images/4912366-p-500.jpeg 500w, images/4912366-p-800.jpeg 800w, images/4912366-p-1080.jpeg 1080w, images/4912366-p-1600.jpeg 1600w, images/4912366.jpg 2000w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294e7-3eed4f0e" className="af-class-bold-text af-class-hour">100%</div><img id="w-node-cecf1ef9-d9e1-39e8-69a8-5c04138294e9-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/Df_1886.jpg" loading="lazy" srcSet="images/Df_1886-p-1080.jpeg 1080w, images/Df_1886-p-1600.jpeg 1600w, images/Df_1886-p-2000.jpeg 2000w, images/Df_1886-p-2600.jpeg 2600w, images/Df_1886-p-3200.jpeg 3200w, images/Df_1886.jpg 5833w" alt className="af-class-small-avatar" />
                    ...
                    <div data-w-tab="Tab 3" className="af-class-tab-pane w-tab-pane">
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf39-3eed4f0e" className="af-class-bold-text af-class-hour">1.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf3b-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf49-3eed4f0e" className="af-class-bold-text af-class-hour">2.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf4b-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf57-3eed4f0e" className="af-class-bold-text af-class-hour">3.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf59-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf67-3eed4f0e" className="af-class-bold-text af-class-hour">4.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf69-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf77-3eed4f0e" className="af-class-bold-text af-class-hour">5.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf79-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf87-3eed4f0e" className="af-class-bold-text af-class-hour">6.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf89-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
                      ...
                      <div data-delay={300} data-hover="false" className="af-class-accordion w-dropdown">
                        <div className="af-class-accordion-container w-dropdown-toggle">
                          <div className="af-class-event-content">
                            <div id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf95-3eed4f0e" className="af-class-bold-text af-class-hour">7.</div><img id="w-node-_56a82b20-1fbe-b171-5f9c-7f1fcf4abf97-3eed4f0e" sizes="(max-width: 479px) 48px, (max-width: 767px) 10vw, (max-width: 991px) 7vw, 70px" src="images/17973866.jpg" loading="lazy" srcSet="images/17973866-p-500.jpeg 500w, images/17973866-p-800.jpeg 800w, images/17973866-p-1080.jpeg 1080w, images/17973866-p-1600.jpeg 1600w, images/17973866-p-2000.jpeg 2000w, images/17973866-p-2600.jpeg 2600w, images/17973866-p-3200.jpeg 3200w, images/17973866.jpg 4001w" alt className="af-class-small-avatar" />
            ...
            <div className="af-class-section af-class-white af-class-_1 af-class-wf-section">
              <div className="af-class-container">
                <div className="af-class-center-container">
                  <h5 data-w-id="aaafed61-71f3-ebe3-6125-af1a363845c5" style={{opacity: 0}} className="af-class-h2 af-class-dark af-class-_1">OUR LEADERSHIP HAS BEEN SEEN ON </h5>
                  <div data-w-id="85846458-9e2b-9c25-a12c-12c29060ea92" style={{opacity: 0}} className="af-class-main-grid af-class-top-margin"><img src="images/Forbes-download-3.png" loading="lazy" width={125} id="w-node-ca8da137-fdb5-69e6-aebb-e5b44761fff5-3eed4f0e" alt /><img src="images/fox2_logo.png" loading="lazy" width={91} id="w-node-_0deb5812-1eb9-a44a-5b7e-31844dcf6300-3eed4f0e" alt /><img src="images/nbc-logo.png" loading="lazy" width={173} id="w-node-f8998c8e-9054-5db5-81f6-72a64c0939aa-3eed4f0e" srcSet="images/nbc-logo-p-500.png 500w, images/nbc-logo-p-800.png 800w, images/nbc-logo-p-1080.png 1080w, images/nbc-logo-p-1600.png 1600w, images/nbc-logo-p-2000.png 2000w, images/nbc-logo.png 4096w" sizes="(max-width: 991px) 100vw, 1vw" alt /><img src="images/cbs-logo-png-transparent.png" loading="lazy" width={130} id="w-node-_7705689c-d0f2-6de9-53b0-6f847de71193-3eed4f0e" srcSet="images/cbs-logo-png-transparent-p-500.png 500w, images/cbs-logo-png-transparent-p-800.png 800w, images/cbs-logo-png-transparent-p-1080.png 1080w, images/cbs-logo-png-transparent-p-1600.png 1600w, images/cbs-logo-png-transparent-p-2000.png 2000w, images/cbs-logo-png-transparent.png 2200w" sizes="(max-width: 991px) 100vw, 1vw" alt /><img src="images/business-ghana-color-1.png" loading="lazy" id="w-node-_48bbf775-1b7e-9609-6857-5b786e7e990b-3eed4f0e" alt /><img src="images/black-enterprise-logo-1.png" loading="lazy" id="w-node-bc1b8b02-a175-ae8a-8584-c061495e6e61-3eed4f0e" alt /></div>
                  <h2 data-w-id="bfad7f7d-a39e-c746-7563-53a9e0dac9ba" style={{opacity: 0}} className="af-class-h2 af-class-dark af-class-_1 af-class-_2">&amp; EXECUTED GLOBAL PROJECTS IN </h2>
                  <div data-w-id="10c71d20-f6d1-053f-be84-f56312c4fd24" style={{opacity: 0}} className="af-class-main-grid af-class-top-margin af-class-_2"><img src="images/Flag_of_Kenya_sm.png" loading="lazy" width={117} id="w-node-_10c71d20-f6d1-053f-be84-f56312c4fd25-3eed4f0e" srcSet="images/Flag_of_Kenya_sm-p-500.png 500w, images/Flag_of_Kenya_sm-p-800.png 800w, images/Flag_of_Kenya_sm.png 900w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /><img src="images/Flag_of_Somalia_sm.png" loading="lazy" width={114} id="w-node-_10c71d20-f6d1-053f-be84-f56312c4fd26-3eed4f0e" srcSet="images/Flag_of_Somalia_sm-p-500.png 500w, images/Flag_of_Somalia_sm.png 900w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /><img src="images/Flag_of_Angola_sm.png" loading="lazy" width={173} id="w-node-_10c71d20-f6d1-053f-be84-f56312c4fd27-3eed4f0e" srcSet="images/Flag_of_Angola_sm-p-500.png 500w, images/Flag_of_Angola_sm-p-800.png 800w, images/Flag_of_Angola_sm.png 900w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /><img src="images/Flag_of_Djibouti_sm.png" loading="lazy" width={130} id="w-node-_10c71d20-f6d1-053f-be84-f56312c4fd28-3eed4f0e" srcSet="images/Flag_of_Djibouti_sm-p-500.png 500w, images/Flag_of_Djibouti_sm.png 900w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /><img src="images/Flag_of_Ethiopia_sm.png" loading="lazy" width={130} id="w-node-_350939a5-2960-668a-2c03-4dca87756752-3eed4f0e" srcSet="images/Flag_of_Ethiopia_sm-p-500.png 500w, images/Flag_of_Ethiopia_sm-p-800.png 800w, images/Flag_of_Ethiopia_sm.png 900w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /><img src="images/Flag_of_the_Democratic_Republic_of_the_Congo_sm.png" loading="lazy" width={130} id="w-node-_119e8622-7c4d-4791-8dce-90d84cd89887-3eed4f0e" alt /><img src="images/640px-Flag_of_Albania.svg.png" loading="lazy" width={109} id="w-node-_10c71d20-f6d1-053f-be84-f56312c4fd2a-3eed4f0e" srcSet="images/640px-Flag_of_Albania.svg-p-500.png 500w, images/640px-Flag_of_Albania.svg.png 640w" sizes="(max-width: 479px) 1.8625000715255737px, (max-width: 767px) 1vw, 2vw" alt /></div>
                </div>
              </div>
            </div>
              ...
              <div className="af-class-container">
                <div className="af-class-center-container">
                  ...
                  <div className="af-class-social-links">
                    <a href="https://www.facebook.com/" target="_blank" className="af-class-social af-class-right-margin w-inline-block"><img src="images/open-sea-white.png" loading="lazy" alt className="af-class-social-icon" /></a>
                    <a href="https://www.facebook.com/" target="_blank" className="af-class-social af-class-right-margin w-inline-block"><img src="images/Discord-Logo_White.png" loading="lazy" sizes="28px" srcSet="images/Discord-Logo_White-p-500.png 500w, images/Discord-Logo_White-p-800.png 800w, images/Discord-Logo_White-p-1080.png 1080w, images/Discord-Logo_White-p-1600.png 1600w, images/Discord-Logo_White.png 2747w" alt className="af-class-social-icon" /></a>
