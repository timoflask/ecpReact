...
class PrivacyPolicyView extends React.Component {
  static get Controller() {
    ...
    try {
      Controller = require('..\controllers/PrivacyPolicyController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '61b91d17e8f31b5fdfed4f20'
  ...
  render() {
    const proxies = PrivacyPolicyView.Controller !== PrivacyPolicyView ? transformProxies(this.props.children) : {
